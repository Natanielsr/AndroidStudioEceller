...
public class LoginComEmailSenhaWS
{
    ...
    public LoginComEmailSenhaWS(Context context, String email, String senha){
    ...
    static String POST(String url, String emailP, String senhaP){
        ...
        try {
            ...
            String json = "{\"email\":\""+emailP+"\",\"senha\":\""+senhaP+"\"}";
            Log.i("Json", json);
    ...
    public void login()
    {
        ...
        new HttpAsyncTask().execute(ConexaoWS.url+"/loginComEmailSenha");
    }
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        {
            return POST(urls[0],email,senha);
        }
        ...
        protected void onPostExecute(String result)
        {
            ...
            try {
                ...
                if(r.equals("null"))
                {
                    Toast.makeText(context, "Email e/ou Senha Inválidos", Toast.LENGTH_LONG).show();
                }
                else
                {
